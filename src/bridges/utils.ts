...
const utilsBridge = {
    ...
    getArticleRating: async (itemId: number) => {
        return await ipcRenderer.invoke("get-article-rating", itemId)
    },
    ...
    // Electron IPC bridge for translation and other main process features
    electron: {
