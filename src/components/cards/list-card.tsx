...
const ListCardInner: React.FunctionComponent<Card.Props & { titleTranslations: { [itemId: number]: string } }> = (props) => {
...
export default connect(mapStateToProps)(ListCardInner)
