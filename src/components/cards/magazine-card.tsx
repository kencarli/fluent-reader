...
const MagazineCardInner: React.FunctionComponent<Card.Props & { titleTranslations: { [itemId: number]: string } }> = (props) => {
...
export default connect(mapStateToProps)(MagazineCardInner)
