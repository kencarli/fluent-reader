...
> {
    ...
    checkOllamaConnection = async () => {
        ...
        if (settings.ollamaApiUrl && settings.ollamaModel) {
            try {
                ...
                if (response.ok) {
                    this.setState({ ollamaConnected: true })
                }
            } catch (e) {
                this.setState({ ollamaConnected: false })
            }
        }
    }
    ...
    render() {
        const { localSettings, ollamaConnected, ratedCount } = this.state
                        ...
                        <>
                            ...
                            {!ollamaConnected && (
                                <MessageBar messageBarType={MessageBarType.warning}>
                                    请先在"AI 服务配置"或"翻译服务配置"中配置 Ollama API 地址和模型。
                                </MessageBar>
                            )}
                        </>
                    )}
