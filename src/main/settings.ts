...
ipcMain.on("get-integration-settings", event => {
    const settings = store.get(INTEGRATION_STORE_KEY, {})
    // console.log('[Settings] Getting integration settings:', {
    //     hasOllamaUrl: !!settings.ollamaApiUrl,
    //     hasOllamaModel: !!settings.ollamaModel,
    //     ollamaUrl: settings.ollamaApiUrl,
    //     ollamaModel: settings.ollamaModel,
    // })
    event.returnValue = settings
})
ipcMain.handle("set-integration-settings", (_, settings: IntegrationSettings) => {
    // console.log('[Settings] Setting integration settings:', {
    //     hasOllamaUrl: !!settings.ollamaApiUrl,
    //     hasOllamaModel: !!settings.ollamaModel,
    //     ollamaUrl: settings.ollamaApiUrl,
    //     ollamaModel: settings.ollamaModel,
