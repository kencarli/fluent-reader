        ...
        if (!this.hasWindow()) {
            this.mainWindow = new BrowserWindow({
                ...
                webPreferences: {
                    ...
                    webSecurity: false,  // Allow cross-origin requests for local Ollama
                },
            })
            ...
            // Disable proxy for local network requests
            this.mainWindow.webContents.session.setProxy({ proxyRules: "" })
        }
    }
